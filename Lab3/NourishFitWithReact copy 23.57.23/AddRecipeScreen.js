...
const AddRecipeScreen = ({navigation}) => {
  ...
  const handleSave = () => {
    addRecipe(newRecipe); // Add the new recipe using the addRecipe function from context
    navigation.goBack(); // Navigate back to the previous screen after adding the recipe
  };
